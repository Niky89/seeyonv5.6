...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse"
	...
	<div class="content-wrapper">
						...
						<table style="text-align: center; margin: auto;">
							...
							<tr id="row1-1">
								...
								<td style="display:none"><input type="hidden" name="wtcount" id="wtcount"
									...
									name="wt1" id="wt1" maxlength="20" size="30"></td>
								<td>
							...
							<tr id="row2-1">
								...
								<td><input type="hidden" name="dfcount" id="dfcount"
									value="1"> <input type="text" class="form-control"
									name="df1" id="df1" size="30" onkeydown= "if(event.keyCode==13){check();return false;}"/></td>
								<td>
							...
							<tr>
								<td colspan="4" style="text-align: right;">
									<div class="btn-group pull-right" role="group">
										<a class="common_button common_button_gray" name="check" id="check"><i
		...
		<div id="content">
			...
			<br>
			<br>
			<font size="5" id="message2"> </font>
			<table id="dftable2" border="1" cellspacing="0" bordercolor="#000000"
				width="80%" style="border-collapse: collapse; margin: auto;"></table>
		</div>
				...
				.checkConflictOfInterest(
						...
						2,
						{
							success : function(data) {
								...
								var tr = "<tr style='background-color: #3882d0;'><td><b>单位类型</b></td><td><b>客户状态</b></td><td>客户名称</td><td>主办律师</td></tr>";
								var add = false;
								/* if(df1!=undefined){
									add=true;
								...
								if (dfmessage != undefined) {
									...
									$.each(dfmessage,
											function(name, value) {
											add = true;
												tr += "<tr><td>"+ value["ls"]+ "</td><td>"+ value["latype"]+ "</td><td>" + name
														+ "</td><td>"
														+ value["zbls"]
														+ "</td></tr>";
											});
					...
					success : function(data) {
						...
						if (dfmessage != undefined) {
							...
							$.each(dfmessage,
									function(name, value) {
										add2 = true;
											tr2 += "<tr><td>&nbsp;&nbsp;"+ value["ls"]+ "</td><td>&nbsp;&nbsp;"+ value["latype"]+ "</td><td>&nbsp;&nbsp;" + name
												+ "</td><td>&nbsp;&nbsp;"
												+ value["zbls"]
												+ "</td><td>&nbsp;&nbsp;"
												+ value["latime"]
