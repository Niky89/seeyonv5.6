...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse"
	...
	<div class="content-wrapper">
				...
				<tr>
					<td>
						<table style="text-align: center; margin: auto;" width="100%">
							<tr id="row1-1">
								<td id="wtlabel" style="text-align: left ;font-size: auto;"><label
								...
								<td><input type="hidden" name="wtcount" id="wtcount"
									...
									name="wt1" id="wt1" width="100%" style="height: 30px !important"></td>
								<!--<td>
								...
								<td id="wtaction">
									<DIV id="wtaddDiv">
										<a id="addImg" class="weui_btn weui_btn_mini weui_btn_primary">+</a>
									</DIV>
									<DIV id="wtdelDiv" style="display: none;">
										<a id="delImg" class="weui_btn weui_btn_mini weui_btn_primary">-</a>
									</DIV>
								</td>-->
							</tr>
							<tr>
							...
							<tr id="row2-1">
								<td style="text-align: left ;font-size: auto;" id="dflabel"><label
							...
							<tr>
								<td colspan="3" style="text-align: right;">
									<div class="btn-group pull-right" role="group">
										<a class="weui_btn weui_btn_primary" id="check" style="background-color: #074888 !important"><i
											class="fa  fa-send-o fa-fw"></i>冲突检测</a><!--  <a
		...
		<div id="content" style="text-align: left; ">
			...
			<div id="wttable" cellspacing="0" bordercolor="#000000" style="border: solid 1px #ccc;display: none;" 
				  width="100%">
			</div>
			<br>
			<br>
			...
			<div id="dftable" cellspacing="0" bordercolor="#000000" 
				 style="border: solid 1px #ccc;display: none;" width="100%"></div>
	...
	<script type="text/javascript">
		...
		function addwt() {
			...
			var html = '<tr id="row1-'+wtcount+'"><td><input type="text" class="weui_input" name="wt'+wtcount+'" id="wt'+wtcount+'" size="auto"></td>'
					+ '<td></td>'
					+ '</tr>';
		...
		function adddf() {
			...
			var html = '<tr id="row2-'+dfcount+'"><td><input type="text" class="weui_input" name="df'+dfcount+'" id="df'+dfcount+'" size="auto"></td>'
					+ '<td></td>'
					+ '</tr>';
		 	...
		 	coim.checkConflictOfInterest(
							...
							1,
							{
								success : function(data) {
									...
									var tr = '<h3 class="page_title" style="color:#074888"> 已有案件对方当事人:</h3>'+
									...
									if (add) {
										...
										$("#wttable").html(tr);
										add = false;
										$("#wttable").css("border-style","solid");
									} else {
										$("#wttable").html(
												"<i class='weui_icon_success_circle' style='font-size:18px;'>委托人没有冲突</i>");
										$("#wttable").css("border-style","none");
									}
									if(isok){
										$("#loadingToast").css("display","none");
										}
									
									$("#wttable").css("display","block");
					...
					3,
					{
						success : function(data) {
							...
							if (add) {
								$("#dftable2").html(tr);
								//$("#dftable").attr("border","1");
								$("#dftable2").css("border-style","solid");
								add = false;
							} else {
								$("#dftable2").html(
										"<i class='weui_icon_success_circle'>对方当事人没有冲突</i>");
